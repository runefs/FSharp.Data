...
module XsdBuilder =
    ...
    let private NativeTypes = 
       [for (name,t)  in 
            [("string"      , typeof<string>)
             ...
             ("boolean"     , typeof<bool>)
             ("positiveInteger", typeof<System.Int64>)
             ("nonNegativeInteger", typeof<System.Int64>)
             ("gYear", typeof<string>)
             ("{http://www.w3.org/2001/XMLSchema}nonNegativeInteger", typeof<System.Int64>)
             ("{http://www.w3.org/2001/XMLSchema}positiveInteger", typeof<System.Int64>)
             ...
             ("{http://www.w3.org/2001/XMLSchema}token"       , typeof<string>)
             ...
             ("{http://www.w3.org/2001/XMLSchema}gYear" , typeof<string>)
             ] 
               do
    ...
    and private getElementsFromObject (item:XmlSchemaObject) : XmlSchemaObject list =
        ...
        match item with
          ...
          | Unknown _ -> [] 
          | Schema s -> 
              [for el in s.Elements do yield el :?> XmlSchemaObject]
              |> getItemsFromCollection
                 ...
                 let t = 
                     ...
                     | Simple(SimpleType.Restricted(_,re)) ->
                         ...
                         Restriction re ->
                             ...
                             null -> 
                                 let name = re.BaseTypeName |> qnToString
                                 NativeTypes.[name]
                             | _ as baseType -> 
